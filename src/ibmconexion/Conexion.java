...
class Conexion {
  ...
  public Conexion(String userDB, String passDB,String serverName, int puerto, String db) throws ClassNotFoundException{
      ds=new com.ibm.db2.jcc.DB2SimpleDataSource();
      ((com.ibm.db2.jcc.DB2BaseDataSource) ds).setServerName(serverName);
      ((com.ibm.db2.jcc.DB2BaseDataSource) ds).setPortNumber(puerto);
      ((com.ibm.db2.jcc.DB2BaseDataSource) ds).setDatabaseName(db);
      ((com.ibm.db2.jcc.DB2BaseDataSource) ds).setDriverType(4);
       try {
            ...
            conexion = ds.getConnection(userDB,passDB);
